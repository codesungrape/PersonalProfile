    ...
    <section id="contact" className="py-20 px-4 md:px-8 relative">
      ...
      >
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <a
            href="mailto:miss.s.rai@outlook.com"
            className="inline-block bg-matrix-green text-matrix-black font-semibold py-3 px-8 rounded-full hover:bg-matrix-lightGreen transition duration-300"
          >
        ...
        <div className="mt-12 flex justify-center space-x-6">
          <a
            href="https://linkedin.com/in/shanti-rai-044902199"
            target="_blank"
            rel="noopener noreferrer"
            className="text-matrix-darkGreen hover:text-matrix-lightGreen transition duration-300"
          >
